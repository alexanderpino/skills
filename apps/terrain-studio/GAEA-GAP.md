...
| `hydraulic`, `erosion2` | Erosion, Erosion2, EasyErosion, Wizard, Wizard2 | **Weaker in variety, arguably stronger in honesty.** Gaea ships five hydraulic entry points (presets/engines over one process). We ship two, one of which selects virtual-pipe vs droplet — and BACKLOG **C1** records that the choice is currently made by *hardware*, which is a defect, not a feature. |
