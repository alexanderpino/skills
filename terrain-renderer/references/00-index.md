...
| Water caustics: refracted-ray-convergence mesh (distorted projector grid, additive overlap) | `12` | Uralsky, "Rendering Water Caustics", *GPU Gems*, 2004 — chapter number/mechanism from model knowledge, not fetched this session | D/? | — |
| Water caustics: animated flipbook projection, depth/extinction-masked | `12` | Production practice since fixed-function era; no canonical source | F | — |
| Subsurface bubble plume (aerated water as a scattering volume, not surface foam) | `12` | Bubble size/void fraction from Dierssen 2019; optics assembled from this skill's own Mie-regime derivation; Deane & Stokes, *Nature* 418 (2002) for breaking-wave bubble creation — **not refetched** | P/synthesis/? | [frontiersin.org](https://www.frontiersin.org/journals/earth-science/articles/10.3389/feart.2019.00014/full) |
