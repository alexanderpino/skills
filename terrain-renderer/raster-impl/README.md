...
1. **Which separated form.** The chapter names one separated *escape* leg and it
   ...
   the second form and its τ-scaling table is the first**, and it says so
   nowhere. The identification is not a guess: `2E₃(τ)²·R_int` gives
   0.1389/0.3614/0.4546 against the chapter's printed 0.1389/0.3614/0.4546, and
   the other form gives 0.1502/0.3650/0.4549. Two suite rows pin each.
...
`12` presents the τ-scaling table as a function of **optical depth alone**. It is
