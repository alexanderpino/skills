...
| **Tectonic / orogeny** | isostasy + SPL uplift + **fault scarps & fault-as-K** (`tectonics.py`) | Cordonnier 2016 uplift+fluvial; Sculpting Mountains 2018 | **SOTA & ahead of all commercial tools** | foreground it; optional flexural isostasy / folds |
