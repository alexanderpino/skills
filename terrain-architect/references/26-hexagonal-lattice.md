...
The flat-domain sibling of `08`'s spherical hex-DGGS section, and the **fourth cure** in `09`'s
grid-anisotropy family: change the lattice so no preferred axis exists.
