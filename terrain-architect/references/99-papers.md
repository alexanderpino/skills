...
- **Longuet-Higgins, M.S. & Stewart, R.W. (1962).** *Radiation stress and mass transport in gravity
  waves, with application to 'surf beats'.* Journal of Fluid Mechanics, 481–504 (volume not
  re-verified). — The radiation-stress concept: waves carry momentum whose convergence at breaking
  drives setup and the nearshore circulation — the engine of the surf-zone loop (`12`).
- **Longuet-Higgins, M.S. (1970).** *Longshore currents generated by obliquely incident sea waves,
  ...
  applied: alongshore thrust `(E_b/4)·sin 2θ_b`, the longshore-current profile across the surf
  zone. The current that executes CERC transport (`12`).
...
- **Bailard, J.A. (1981).** *An energetics total load sediment transport model for a plane sloping
  ...
  cross-shore transport closure (`12`).
- **Wright, L.D. & Short, A.D. (1984).** *Morphodynamic variability of surf zones and beaches: a
  synthesis.* Marine Geology 56(1), 93–118. — The beach-state model: `Ω = H_b/(w_s·T)` classifies
...
- **MacMahan, J.H., Thornton, E.B. & Reniers, A.J.H.M. (2006).** *Rip current review.* Coastal
  Engineering 53(2–3), 191–208. — Field synthesis of rip kinematics, spacing (O(100–1000 m),
  irregular), and morphodynamic feedback (`12`).
- **O'Brien, M.P. (1969).** *Equilibrium flow areas of inlets on sandy coasts.* Journal of the
  ...
  `A = C·P^n`, `n ≈ 0.85`; the scour feedback that keeps inlets open and sizes their deltas (`12`).
- **Paola, C. & Voller, V.R. (2005).** *A generalized Exner equation for sediment mass balance.*
  Journal of Geophysical Research — Earth Surface 110, F04014. — The sediment-continuity law
  `∂h/∂t = −∇·q/(1−p)` in its general form; closes every morphodynamic loop in this skill,
  surf zone included (`12`).
