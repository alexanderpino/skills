...
| `references/05-erosion-thermal-aeolian.md` | Thermal/talus, mass wasting (landslides, debris flows), wind transport, Werner dune model, anchored/obstacle dunes (echo, climbing, falling, sand ramps, shadow dunes) |
...
| `references/16-arid-desert.md` | Arid/desert landforms: yardangs, inselbergs/bornhardts, alluvial fans & bajadas, playas, desert pavement, wadis, loess & sand sheets, obstacle dunes & sand ramps (banked against terrain; mechanism in `05`) |
