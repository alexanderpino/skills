...
| `references/16-arid-desert.md` | Arid/desert landforms: yardangs, inselbergs/bornhardts, alluvial fans & bajadas, playas, evaporite crusts & salterns (biogenic pink colour), desert pavement, wadis, loess & sand sheets, obstacle dunes & sand ramps (banked against terrain; mechanism in `05`) |
