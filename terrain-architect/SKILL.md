...
| `references/20-archetypes.md` | **Archetype blueprints.** Named landscapes (Alps, Himalaya, Grand Canyon, Namib, Death Valley, Guilin karst, Niagara & Victoria Falls, fjords, sea stacks, atolls, salt flats…) as regime settings over the Legal Order — the *province* altitude between one-landform (`00`) and one-world (`13`). Adapt-don't-paste; each carries a verification signature |
