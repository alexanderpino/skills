...
*The Site Reliability Workbook*, 2018) and ISO/IEC 25010:2023 **reliability**
(availability, faultlessness, fault tolerance, recoverability) and **performance
efficiency**.
...
- **SLO — service level objective.** The target for an SLI over a period:
  ...
  measure**, operationalised. (An SLA is an SLO with contractual penalties —
  a business document; the architecture works to the SLO.)
...
point objective — how much data loss is tolerable). They are ISO 25010
...
nightly backups. Verified by a restore drill, not by the existence of backups.
