...
sources:
  ...
  - { id: stendardo2020, tier: P, locator: "Abstract p.1 for the 3.4 km at 0.5 m in up to two hours figure; §3.2 pp.7-8 with Code Listings 1-3 on p.8 for the per-point DDA march and the coarse-DTM substitution beyond the tile, combined by DISJUNCTION -- section 3.2 explicitly rejects taking the minimum, which was its own earlier section 2 method" }
