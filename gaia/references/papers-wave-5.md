---
type: Bibliography
title: Papers — coastal erosion
description: "Sources for the fifth-wave document on what waves do to the land: the equilibrium beach profile and its scale parameter, the Bruun rule and the published case for abandoning it, alongshore transport and the one-line shoreline model, the high-angle wave instability, and threshold-driven cliff retreat."
tags: [bibliography, provenance, generation, coastal]
status: draft
generated: { by: process:claude-code, at: 2026-09-03T00:00:00Z }
---
# Papers — coastal erosion

One family, added for `coastal-erosion.md`. Entry format, tier definitions and the two
