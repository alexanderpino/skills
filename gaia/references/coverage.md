...
- **impact-craters** `planned` — How do you place craters with the right depth-to-diameter law, rim, ejecta and superposition? Conspicuously absent next to planetary-precision.md, and cheaply groundable.
...
- **mesh-extraction** `planned` — How do you get a mesh out, offline? heightfield-lod.md is entirely runtime; nothing covers TIN extraction, error-driven simplification, or the offline LOD chain a tool has to export.
