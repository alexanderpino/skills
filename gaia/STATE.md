...
| Guards | `check.py` exit 0 · `--selftest` green · `index --check` current · `requote --selftest` green · CI `bites` **39 red + 5 green**, every mutation biting for the reason its row names |
